...
declare class RenderData {
    ...
    get width(): number;
    get height(): number;
    get transforms(): Float32Array<ArrayBufferLike>;
    get transformsWidth(): number;
    get transformsHeight(): number;
    get transformIndices(): Uint32Array<ArrayBufferLike>;
    get transformIndicesWidth(): number;
    get transformIndicesHeight(): number;
    get colorTransforms(): Float32Array<ArrayBufferLike>;
    get colorTransformsWidth(): number;
    get colorTransformsHeight(): number;
    get colorTransformIndices(): Uint32Array<ArrayBufferLike>;
